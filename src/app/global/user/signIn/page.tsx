...
return (
        <form onSubmit={handleSubmit} className=" p-8 rounded-lg shadow-2xl w-[70%] max-w-[500px] flex-center flex-col bg-gradient-to-br from-sky-900 via-teal-900 to-indigo-900 "> 
